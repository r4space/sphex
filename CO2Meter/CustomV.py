...
class GPIC(object):
    """ The filtered global position (e.g. fused GPS and accelerometers). The position is in GPS-frame (right-handed, Z-up).
        ...
        :param time_ut:    uint64_t    Timestamp (microseconds since UNIX epoch) in UTC. 0 for unknown. Commonly filled by the precision time source of a GPS receiver.
        ...
        :param long: int32_t Longitude, expressed as degrees * 1E7
    ...
    def __str__(self):
        ...
        """
        return "GPIC: time_boot_us={},time_ut={},estimator_type={},lat={},long={},alt={},relative_alt={},vx,={},vy={},vz={},covariance={}".format(
            self.time_boot_us, self.time_ut, self.estimator_type, self.lat, self.long, self.relative_alt, self.vx,
